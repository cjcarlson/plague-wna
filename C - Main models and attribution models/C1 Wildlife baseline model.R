...
saveRDS(modelW, '/nfs/ccarlson-data/yersinia/2020Pipeline/Outputs/modelW.RDS')
saveRDS(yearlys.W, '/nfs/ccarlson-data/yersinia/2020Pipeline/Outputs/yearlysW.RDS')
