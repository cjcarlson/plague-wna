...
modelH <- bart.step(human[,c('rodent','cec','ph','sand','clay','orgc','Fe','Ca','Na','elev',
                             'tmin','tmean','tmax','ppt','ppt.n','tmp.n')],human[,'case'],
                    full = FALSE,
                    iter.step = 200)
...
saveRDS(modelH, '/nfs/ccarlson-data/yersinia/2020Pipeline/Outputs/modelH.RDS')
saveRDS(yearlys.H, '/nfs/ccarlson-data/yersinia/2020Pipeline/Outputs/yearlysH.RDS')
