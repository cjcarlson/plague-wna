...
modelW <- bart(x.train = wild[,c('rodent','cec','ph','sand','clay','orgc','Fe','Ca','Na','elev',
...
saveRDS(modelW, '/nfs/ccarlson-data/yersinia/2020Pipeline/Wild-Alt1/modelW.RDS')
saveRDS(yearlys.W, '/nfs/ccarlson-data/yersinia/2020Pipeline/Wild-Alt1/yearlysW.RDS')
