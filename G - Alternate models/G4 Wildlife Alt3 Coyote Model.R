...
wild <- read.csv('./2020Pipeline/Inputs/NWDPdataCoyote.csv')
...
saveRDS(modelW, '/nfs/ccarlson-data/yersinia/2020Pipeline/Wild-Alt3/modelW.RDS')
saveRDS(yearlys.W, '/nfs/ccarlson-data/yersinia/2020Pipeline/Wild-Alt3/yearlysW.RDS')

# Partials

setwd('/nfs/ccarlson-data/yersinia/2020Pipeline/Wild-Alt3/')
